...
pub fn push_pop_small_batch_st3_generic(c: &mut Criterion) {
    push_pop::<usize, st3::Worker<_, st3::B256>, 64>("small_batch-st3_generic", c);
}
...
pub fn push_pop_large_batch_st3_generic(c: &mut Criterion) {
    push_pop::<usize, st3::Worker<_, st3::B256>, 256>("large_batch-st3_generic", c);
}
...
pub fn executor_st3_generic(c: &mut Criterion) {
    executor::<usize, st3::Worker<_, st3::B256>>("st3_generic", c);
}
...
criterion_group!(
    benches,
    push_pop_small_batch_st3_generic,
    ...
    push_pop_large_batch_st3_generic,
